  ...
  return {
    ...
    hooks: {
      'astro:config:setup': async ({ config, updateConfig }) => {
        ...
        // Add built-in transportation only if they are not already added by the user through the
        ...
        // plugins injected by Starlight plugins through Astro transportation can handle text and
        // leaf directives before they are transformed back to their original form.
        // transportation.push(starlightDirectivesRestorationIntegration())

        // Add transportation immediately after Starlight in the config array.
        // This ensures users can add transportation before/after Starlight and we respect that order.
